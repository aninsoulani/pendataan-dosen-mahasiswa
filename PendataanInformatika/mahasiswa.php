  ...
  $status = $_GET["status"];
    ...
    $dosen_pembimbing = $_POST['dosen_pembimbing'];
		...
		if ($baris >= 1) {
			...
			$add = mysqli_query($conn, "INSERT INTO mahasiswa (nim, nama_mahasiswa, password, angkatan, status, keterangan, nip_dospem) VALUES ('$nim', '$nama', '$password', '$angkatan', '$status', '$keterangan', '$dosen_pembimbing')");
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Data Mahasiswa Informatika Unsoed</h4>
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
                          <?php
													$sql = mysqli_query($conn, "SELECT * FROM mahasiswa WHERE status='3' ORDER BY nim ASC");
													$i = 0;
            ...
            <form action="" method="POST" class="needs-validation" novalidate="">
              ...
              <div class="form-group">
                ...
                <select class="form-control selectric" name="dosen_pembimbing">
                  <?php 
                  $dospem = mysqli_query($conn, "SELECT * FROM dosen  ORDER BY nip ASC");
                  ?>
                  <?php
                  while($data = mysqli_fetch_array($dospem)){
                    ?>
                  <option value="<?=$data['nip']?>"><?=$data['nama_dosen']?></option>
                  <?php
                  }
                  ?>
                </select>
